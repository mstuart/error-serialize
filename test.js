...
test("unknown error name falls back to Error", (t) => {
  const error = deserialize({ message: "custom", name: "CustomError" });
  t.true(error instanceof Error);
